...
def get_training_data(source, class_label, seed):
    ...
    data = np.load((source+'//Eembeddings.npy'))
    print(data)
    ...
    train, test, train_labels, test_labels = train_test_split(train, train_labels, test_size=0.2, random_state=3, stratify=train_labels)
