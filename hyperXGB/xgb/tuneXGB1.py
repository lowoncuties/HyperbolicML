...
class my_randomForest:
    ...
    def configspace(self) -> ConfigurationSpace:
        ...
        max_depth = Integer("max_depth", (5, 10), default=6)#5,40
...
class tune_MySVM_MyRF():
    ...
    def run_method_tune(self):
        ...
        scenario = Scenario(
            ...
            n_trials=15,  # 224,We want to run max 50 trials (combination of config and seed)
        )
...
class erade_pxgb():
    ...
    def __init__(self):
        ...
        self._eta = [0.1,  0.05],  # 0-1(def 0.3)0.3,, 0.2
...
class classifier_tuneXGB():
    ...
    def allocate(self):
        ...
        incumbent_cost, incumbent, smach = self.exgb.run_exgb(trails_num = 11)
